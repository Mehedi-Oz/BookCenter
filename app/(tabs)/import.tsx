...
export default function ImportScreen() {
  ...
  const { importBooksFromCSV, refreshData } = useBookStore();
      ...
      <ScrollView style={styles.content}>
        <View style={[styles.guideCard, { backgroundColor: colors.surface }]}>
          ...
          <View style={styles.guideSection}>
            ...
            <Text style={[styles.columnItem, { color: colors.textSecondary }]}>• Publisher - Publisher/publication</Text>
            <Text style={[styles.columnItem, { color: colors.textSecondary }]}>• Notes - Additional book details</Text>
          </View>
          ...
          <View style={styles.guideSection}>
            ...
            <View style={[styles.exampleCode, { backgroundColor: colors.border }]}>
              <Text style={[styles.codeText, { color: colors.textSecondary }]}>
                Name | Price | Author | Publisher | Notes{'\n'}
                Book A | 12.99 | John | ABC Press | Good book{'\n'}
                Book B | 8.50 | Jane | XYZ Ltd | Nice read{'\n'}
                Book C | 15.00 | Bob | DEF Co | Great story
              </Text>
            </View>
          </View>
